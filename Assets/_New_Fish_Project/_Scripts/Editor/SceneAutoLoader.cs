    ...
    private static void OnPlayModeChanged()
    {
        ...
        if ( !EditorApplication.isPlaying && EditorApplication.isPlayingOrWillChangePlaymode )
        {
            ...
            if ( EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo() )
            {
                ...
                bool scene_master_loaded = ( EditorSceneManager.GetActiveScene().path == MasterScene );
                if ( !scene_master_loaded )
                {
        ...
        if( !EditorApplication.isPlaying && !EditorApplication.isPlayingOrWillChangePlaymode )
        {
            ...
            bool scene_previous_loaded = ( EditorSceneManager.GetActiveScene().path == PreviousScene );
            if ( !scene_previous_loaded )
            {
